    ...
    case message of
        FetchDone newResource ->
            ...
            let
                ...
                newResources = Dict.insert newResource.resource_id newResource resources
            in
...
dataRetrieval model =
    case model.layout of
        BookPage book ->
            ...
            -- have already.
            let
                _ = Debug.log "Got Resources: " (Dict.keys model.resources)
                neededResources = Maybe.withDefault [] book.resources
                _ = Debug.log "Need Resources: " neededResources
